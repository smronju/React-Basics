...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Contacts = __webpack_require__(159);

	var _Contacts2 = _interopRequireDefault(_Contacts);

	var _global = __webpack_require__(163);

	var _global2 = _interopRequireDefault(_global);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	_reactDom2.default.render(_react2.default.createElement(_Contacts2.default, { initialValue: 10 }), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ContactTable = __webpack_require__(160);
	...
	var Contacts = function (_Component) {
	    ...
	    function Contacts(props) {
	        ...
	        _this.handleSearch = function (searchText) {
	            _this.setState({ filterText: searchText });
	        };
	    ...
	    _createClass(Contacts, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_Search2.default, { filterText: this.state.filterText, onSearch: this.handleSearch }),
	                _react2.default.createElement(_ContactTable2.default, { filterText: this.state.filterText, contacts: _contacts })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ContactRow = __webpack_require__(161);
	...
	var ContactTable = function (_Component) {
	    _inherits(ContactTable, _Component);

	    function ContactTable(props) {
	        _classCallCheck(this, ContactTable);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ContactTable).call(this, props));
	    }
	    ...
	    _createClass(ContactTable, [{
	        ...
	        value: function render() {
	            ...
	            var _rows = this.props.contacts.filter(function (_contact) {
	                return _contact.name.toLowerCase().indexOf(_this2.props.filterText.toLowerCase()) > -1;
	            }).map(function (_contact) {
	                return _react2.default.createElement(_ContactRow2.default, { key: _contact.id, id: _contact.id, name: _contact.name, email: _contact.email, gender: _contact.gender, phone: _contact.phone });
	            });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ContactRow = function (_Component) {
	    ...
	    function ContactRow(props) {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ContactRow).call(this, props));
	    }
	...
	var Search = function (_Component) {
	    ...
	    function Search(props) {
	        ...
	        _this.handleChange = function () {
	            _this.props.onSearch(_this.refs.searchText.value);
	        };
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'col-md-12' },
	                    _react2.default.createElement('input', { type: 'text', ref: 'searchText', onChange: this.handleChange, className: 'form-control', placeholder: 'Search by name' })
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js?modules&localIdentName=[local]---[hash:base64:5]!./../../node_modules/postcss-loader/index.js!./global.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js?modules&localIdentName=[local]---[hash:base64:5]!./../../node_modules/postcss-loader/index.js!./global.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js?modules&localIdentName=[local]---[hash:base64:5]!./../../node_modules/postcss-loader/index.js!./table.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js?modules&localIdentName=[local]---[hash:base64:5]!./../../node_modules/postcss-loader/index.js!./table.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
